...
/// Bridge [HTTPStatusCode](https://kitura-next.github.io/Kitura-net/Enums/HTTPStatusCode.html)
/// from [KituraNet](https://kitura-next.github.io/Kitura-net) so that you only need to import
/// `Kitura` to access it.
