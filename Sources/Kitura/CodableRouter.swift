...
/// Bridge [RequestError](https://kitura-next.github.io/KituraContracts/Structs/RequestError.html)
/// from [KituraContracts](https://kitura-next.github.io/KituraContracts) so that you only need to import
/// `Kitura` to access it.
